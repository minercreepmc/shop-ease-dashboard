...
export type CreateDiscountHttpRequest = V1CreateDiscountHttpRequest;
export type CreateDiscountHttpResponse = V1CreateDiscountHttpResponse;
export type UpdateDiscountHttpRequest = V1UpdateDiscountHttpRequest;
export type UpdateDiscountHttpResponse = V1UpdateDiscountHttpResponse;
